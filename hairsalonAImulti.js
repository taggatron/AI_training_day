        ...
        <div className="flex border-b border-[#27272a] sticky top-0 bg-[#121214] z-10">
          {['services', 'staff', 'marketing'].map(t => (
            <button
              ...
              className={`flex-1 min-w-0 py-3 sm:py-4 text-[11px] sm:text-sm font-bold uppercase tracking-wide sm:tracking-wider whitespace-nowrap truncate touch-manipulation ${
